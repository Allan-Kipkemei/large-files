...
if uploaded_file is not None:
    ...
    # Load accuracy score
    accuracy_score = load_accuracy_score('./accuracy_score.txt')

    # Display the prediction, recommendations, and accuracy score
    ...
    if accuracy_score:
        st.write(f"### Model Accuracy: {accuracy_score}")
